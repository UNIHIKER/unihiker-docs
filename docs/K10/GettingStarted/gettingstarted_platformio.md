...
Platform IO is typically installed via code editor/IDE like CLion or VSCode. This tutorial will introduce how to configure Platform IO in these two IDEs.
...
![CLion logo](https://resources.jetbrains.com.cn/storage/products/company/brand/logos/CLion.svg)
...
6. **Run** test code on Unihiker K10
    ...
    - Build your project and upload code with ``ctrl+F5`` hotkey. The text "Unihiker" will appear on the Unihiker K10 screen.<br/>
